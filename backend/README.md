...
```
cd existing_repo
git remote add origin https://git.foxminded.ua/foxstudent106591/part3-unit9.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.foxminded.ua/foxstudent106591/part3-unit9/-/settings/integrations)
